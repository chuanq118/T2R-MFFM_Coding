...
if __name__ == '__main__':
    ...
    model = ResNet(depth=34,
                   ...
                   style='pytorch',
                   in_channels=4,
                   dilations=(1, 1, 2, 4), #  dilations=(1, 1, 2, 4),
                   strides=(1, 2, 2, 1), # (1, 2, 1, 1),
                   )
    # batchsize % 2==0
    images = torch.rand(size=(4,4, 512, 512))
    images = images.to(device, dtype=torch.float32)
    model.to(device)
    ret1 = model(images)
    print(ret1.shape)
    # baseline
    # 0 = {Tensor: (4, 64, 128, 128)}
    # 1 = {Tensor: (4, 128, 64, 64)}
    # 2 = {Tensor: (4, 256, 32, 32)}
    # 3 = {Tensor: (4, 512, 16, 16)}

    # dilations=(1, 1, 2, 4),
    # strides=(1, 2, 1, 1),
    # 0 = {Tensor: (4, 64, 128, 128)}
    # 1 = {Tensor: (4, 128, 64, 64)}
    # 2 = {Tensor: (4, 256, 64, 64)}
    # 3 = {Tensor: (4, 512, 64, 64)}